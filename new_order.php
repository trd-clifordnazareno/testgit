    ...
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="index.php"><i class="fa fa-home">&nbsp;</i>Home <span class="sr-only">(current)</span></a>
                    ...
                    <li class="nav-item active">
              <a class="nav-link" href="login.php"><i class="fa fa-user">&nbsp;</i>Logout</a>
            </li>
				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return false">
				  		<div class="form-group row">
				  			...
				  			<div class="col-sm-6">
				  				<input type="text" id="order_date" name="order_date" readonly="" class="form-control form-control-sm" value="2020-24-03">
				  			</div>
				  		</div>
				  		<div class="form-group row">
		...
		<!--<tr>
		    ...
		    <td>
		        <select name="pid[]" class="form-control form-control-sm pid" required="">
		            ...
		            <option value="29">Devant TV 55 </option><option value="30">computer destop set</option>		        </select>
		    </td>
		    ...
		    <td>Rs.<span class="amt">0</span></td>
                    ...
                    <div class="form-group row">
                      <label for="gst" class="col-sm-3 col-form-label" align="right">VAT (1%)</label>
                      <div class="col-sm-6">
